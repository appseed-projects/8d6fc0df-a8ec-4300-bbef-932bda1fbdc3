...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-23 13:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8d6fc0df-a8ec-4300-bbef-932bda1fbdc3.git
$ cd 8d6fc0df-a8ec-4300-bbef-932bda1fbdc3
```
